...
public class Question {
    ...
    public Question(long id, String questionText, String answer, long packId, long packOrder) {
        this.id = id;
    ...
    public Question(String questionText, String answer, long packId, long packOrder) {
        this.questionText = questionText;
        this.answer = answer;
        this.packId = packId;
        this.packOrder = packOrder;
